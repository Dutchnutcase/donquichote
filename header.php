...
<html lang="en">
  <head>
    ...
    <meta name="keywords" content="schermen, nijmegen, studenten, bedrijfsuitje, clinic">

    <!-- og -->
    <meta property="og:title" content="NSSV Don Quichote">
    <meta property="og:site_name" content="NSSV Don Quichote"/>
    <meta property="fb:app_id" content="156446461169092" />
    <meta property="og:type" content="website">
    <meta property="og:locale" content="nl_NL">
    <meta property="og:description" content="Voor enthousiaste recreatieve- en wedstrijdschermers, studenten en particulieren. Wij organiseren ook clinics en bedrijfsuitjes.">
    <meta property="og:url" content="http://nssv-donquichote.nl">
    <!-- og -->
        ...
        <div id="myCarousel" class="carousel slide hidden-xs " " data-ride="carousel" >
          ...
          <div class="carousel-inner" role="listbox">
            <div class="item active">
              <img src="<?php echo get_bloginfo('template_directory'); ?>/img/wrapper2.jpg" alt="Bestuur">
            </div>
          </div>
